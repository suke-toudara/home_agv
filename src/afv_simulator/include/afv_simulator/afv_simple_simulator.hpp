#ifndef AFV_SIMULATOR__NAVYU_SIMPLE_SIMULATOR_HPP_
#define AFV_SIMULATOR__NAVYU_SIMPLE_SIMULATOR_HPP_
...
class AfvSimpleSimulator : public rclcpp::Node
{
public:
  AfvSimpleSimulator(const rclcpp::NodeOptions & node_options);
  ~AfvSimpleSimulator();
...
#endif  // AFV_SIMULATOR__NAVYU_SIMPLE_SIMULATOR_HPP_
