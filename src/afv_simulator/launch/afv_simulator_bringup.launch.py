...
def generate_launch_description():
    ...
    world_file = os.path.join(
        get_package_share_directory("afv_simulator"), "world", "willow_garage.world"
    )
    ...
    set_env_gazebo_resource = SetEnvironmentVariable(
        ...
        value=[
            ...
            "/usr/share/gazebo-11",
            pathsep,
            PathJoinSubstitution([get_package_share_directory("afv_simulator"), "world"]),
        ],
    )
    ...
    rviz_config = os.path.join(
        get_package_share_directory("afv_simulator"), "rviz", "default.rviz"
    )
    rviz_node = Node(
